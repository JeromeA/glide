...
EditorTooltipWindow   *editor_tooltip_window_new_popup   (void);
EditorTooltipWindow   *editor_tooltip_window_new_toplevel(void);
void                   editor_tooltip_window_copy_content (EditorTooltipWindow *self,
